...
namespace Sistema_Agencia_de_Viajes
{
    class Reservas1
    {
        ...
        public Reservas1(int ID_Reservas, int ID_Cliente, DateTime Fecha_Salida, DateTime Fecha_Regreso, int Num_Personas, string Estado, double Costo_Total, int ID_Destino)
        ...
        public int AgregarReserva()
        {
            ...
            try
            {
                ...
                string consultaSql = "INSERT INTO Reservas (ID_Cliente, Fecha_Salida, Fecha_Regreso, Num_Personas, Estado, Costo_Total, ID_Destino) VALUES (@ID_Cliente, @Fecha_Salida, @Fecha_Regreso, @Num_Personas, @Estado, @Costo_Total, @ID_Destino)";
                ...
                using (SqlCommand consulta = new SqlCommand(consultaSql, cn))
                {
                    ...
                    consulta.Parameters.AddWithValue("@ID_Destino", this.ID_Destino);
